sound = {
  init = function (self)
    self.presets = {
      ...
      [7] = 'dev_metal_detector_turn_on',
      [8] = 'dev_surveillance_camera_loop_start',
      [9] = 'ui_computer_turn_off',
      [10] = 'ui_tv_turn_off',
      [11] = 'ui_hologram_turn_off',
      [12] = 'ui_hacking_exit',
      [13] = 'ui_terminal_negative',
      [14] = 'dev_metal_detector_turn_off',
      [15] = 'dev_surveillance_camera_turn_off',
      [16] = 'ui_positive',
      [17] = 'ui_generic_set_02_positive',
      [18] = 'ui_generic_set_05_positive',
      [19] = 'ui_generic_set_07_positive',
      [20] = 'ui_generic_set_10_positive',
      [21] = 'ui_generic_set_14_positive',
      [22] = 'ui_hacking_access_panel_close',
      [23] = 'ui_generic_set_03_negative',
      [24] = 'ui_generic_set_06_negative',
      [25] = 'ui_generic_set_07_negative',
      [26] = 'ui_generic_set_09_negative',
      [27] = 'ui_generic_set_13_negative',
      None = 1,
      ui_radio_turn_on = 2,
      ui_tv_turn_on = 3,
